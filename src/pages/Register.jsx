...
const Register = () => {
  ...
  return (
    <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
        ...
        <div className='w-full md:w-2/3 h-fit lg:h-5/6 py-8 lg:py-0 flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl '>
            {/* {left} */}
            <div className='w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center'>
                ...
                <p className='text-ascent-2 text-sm text-center'>Already has na Account? {" "}
                   <Link to='/login' className='text-[#065ad8] ml-2 cursor-pointer font-semibold'>
                            Login
                    </Link>
                </p>
            </div>
